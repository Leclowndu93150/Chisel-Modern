...
public class ChiselWorldGenProvider extends DatapackBuiltinEntriesProvider {
    ...
    public static final ResourceKey<BiomeModifier> ADD_BASALT = ResourceKey.create(
            NeoForgeRegistries.Keys.BIOME_MODIFIERS, Chisel.id("add_basalt"));
    ...
    private static final RegistrySetBuilder BUILDER = new RegistrySetBuilder()
            ...
            .add(NeoForgeRegistries.Keys.BIOME_MODIFIERS, context -> {
                ...
                HolderSet<net.minecraft.world.level.biome.Biome> overworldTag = biomes.getOrThrow(BiomeTags.IS_OVERWORLD);
