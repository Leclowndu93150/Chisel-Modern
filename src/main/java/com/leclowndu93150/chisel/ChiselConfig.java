...
public class ChiselConfig {
    ...
    private static final ModConfigSpec.BooleanValue MARBLE_ENABLED = BUILDER
    ...
    private static final ModConfigSpec.IntValue MARBLE_MAX_Y = BUILDER
            .comment("Maximum Y level for marble generation")
            .defineInRange("worldgen.marble.maxY", 60, -64, 320);

    // Limestone worldgen config
    private static final ModConfigSpec.BooleanValue LIMESTONE_ENABLED = BUILDER
    ...
    private static final ModConfigSpec.IntValue LIMESTONE_MAX_Y = BUILDER
            .comment("Maximum Y level for limestone generation")
            .defineInRange("worldgen.limestone.maxY", 60, -64, 320);

    // Diabase worldgen config
    private static final ModConfigSpec.BooleanValue DIABASE_ENABLED = BUILDER
    ...
    private static final ModConfigSpec.IntValue DIABASE_MAX_Y = BUILDER
            .comment("Maximum Y level for diabase generation")
            .defineInRange("worldgen.diabase.maxY", 0, -64, 320);

    // Basalt worldgen config
    private static final ModConfigSpec.BooleanValue BASALT_ENABLED = BUILDER
    ...
    private static final ModConfigSpec.IntValue BASALT_MAX_Y = BUILDER
