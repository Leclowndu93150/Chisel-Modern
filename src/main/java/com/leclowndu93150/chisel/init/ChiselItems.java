...
public class ChiselItems {
    ...
    public static final RegistryObject<ItemBallOMoss> BALL_O_MOSS = ChiselRegistries.ITEMS.register("ball_o_moss",
            () -> new ItemBallOMoss(new Item.Properties().stacksTo(16)));

    public static final RegistryObject<ItemCloudInABottle> CLOUD_IN_A_BOTTLE = ChiselRegistries.ITEMS.register("cloud_in_a_bottle",
